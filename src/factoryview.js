var FactoryView = function(controller, id, toolbox, workspaceBlocks) {
    ...
    this.toolboxTextarea = BootstrapElement.textArea('toolboxXml', toolbox);
    this.workspaceTextarea = BootstrapElement.textArea('workspaceXml', workspaceBlocks);
    this.middleDiv.append(this.toolboxTextarea);
    this.middleDiv.append(this.workspaceTextarea);
    ...
    this.categoriesName = this.controller.getToolboxCategories(toolbox); // TODO assign good categories
...
FactoryView.prototype.injectPreviewWorkspace = function() {
    return Blockly.inject(this.previewWorkspaceDiv[0], {
        toolbox: this.controller.getToolboxXml()
    });
};

FactoryView.prototype.injectToolboxWorkspace = function() {
    return Blockly.inject(this.toolboxWorkspaceDiv[0], {
...
FactoryView.prototype.injectPreloadWorkspace = function() {
